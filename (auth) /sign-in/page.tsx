    ...
    <div className="flex min-h-screen bg-[#0a0a0a]">
      ...
      <div className="flex flex-col justify-center items-center w-full md:w-[420px] lg:w-[460px] flex-shrink-0 px-8 py-12 relative z-10">
        ...
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-white/30 mb-8">Sign in to continue creating</p>
          ...
          <p className="text-sm text-center mt-6 text-white/25">
            ...
            <a href="/sign-up" className="text-violet-400 hover:text-violet-300 transition-colors font-medium">
              Create one
            </a>
          </p>
        </div>
      ...
      <div className="hidden md:block flex-1 relative overflow-hidden">
        {bgImage ? (
          ...
          /* Default gradient when no admin image is set */
        ...
        {/* Overlay gradient on left edge for blend */}
